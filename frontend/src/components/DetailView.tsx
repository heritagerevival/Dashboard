    ...
    <div style={{ padding: '20px' }}>
      ...
      <Row gutter={[24, 24]}>
        <Col xs={24} lg={8}>
          <Card title="Profile">
            {data.profileImage && (
              <Avatar size={100} src={data.profileImage.startsWith('data:image/') ? data.profileImage : data.profileImage.startsWith('/uploads/') ? `https://api.heritagerevival.co.uk${data.profileImage}` : `data:image/jpeg;base64,${data.profileImage}`} />
            )}
